...
class FakeJobDetectorSVM:
    def __init__(self):
        """
        Initialize the Fake Job Detector with SVM classifier.
        Using TF-IDF as SVMs typically work well with continuous features.
        """
        # Define the pipeline
    ...
    def explain_prediction(self, job_posting):
        ...
        # SVM-specific explanations
        reasons.append("Support vector analysis identified this posting as being statistically similar to known scams")
        
        # If we couldn't find specific reasons, add a generic explanation
        if len(reasons) < 3:
            reasons.append("Multiple suspicious patterns detected using advanced analysis")
            reasons.append("Contains combinations of terms frequently found in fraudulent postings")
    ...
    def load_model(cls, filepath):
        ...
        Returns:
            FakeJobDetectorSVM: Loaded model
        """
